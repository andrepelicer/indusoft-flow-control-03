              ...
              <TableBody>
                {filteredVendedores.map((vendedor) => (
                  <TableRow key={vendedor.id}>
                    ...
                    <TableCell className="hidden lg:table-cell">{vendedor.telefone}</TableCell>
                    <TableCell>{vendedor.comissao}%</TableCell>
                    <TableCell className="hidden sm:table-cell">{formatDate(vendedor.dataAdmissao)}</TableCell>
                    <TableCell>
